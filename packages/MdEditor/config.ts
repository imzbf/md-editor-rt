...
// 代码高亮cdn链接
export const highlightUrl = `${cdnBase}/highlight.js/11.10.0/highlight.min.js`;
...
export const codeCss: CodeCss = {
  a11y: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/a11y-light.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/a11y-dark.min.css`
  },
  atom: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/atom-one-light.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/atom-one-dark.min.css`
  },
  github: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/github.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/github-dark.min.css`
  },
  gradient: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/gradient-light.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/gradient-dark.min.css`
  },
  kimbie: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/kimbie-light.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/kimbie-dark.min.css`
  },
  paraiso: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/paraiso-light.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/paraiso-dark.min.css`
  },
  qtcreator: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/qtcreator-light.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/qtcreator-dark.min.css`
  },
  stackoverflow: {
    light: `${cdnBase}/highlight.js/11.10.0/styles/stackoverflow-light.min.css`,
    dark: `${cdnBase}/highlight.js/11.10.0/styles/stackoverflow-dark.min.css`
  }
};
