...
`html` 控制原生 HTML 的解析，不负责清洗最终输出；需要清洗生成的 HTML 时，请使用 `sanitize`。更多配置说明见 [markdownItConfig](https://imzbf.github.io/md-editor-rt/zh-CN/api#%F0%9F%8D%A4%20markdownItConfig)。
