...
`html` controls raw HTML parsing and does not sanitize the final output. Use `sanitize` when the generated HTML needs sanitization. See [markdownItConfig](https://imzbf.github.io/md-editor-rt/en-US/api#%F0%9F%8D%A4%20markdownItConfig) for more details.
